...
Deuce and ad are different shots (a wide serve goes to opposite wings), so every
statistic is split by side. This experiment asks the measurement question: of the
serve-placement statistics a player card could carry — the wide/body/T mix per side, whether it
...
def write_report(raw, per):
    ...
    md.append("*Generated by `experiments/serve_tendencies/run.py`. Placement is the "
              ...
              "since a wide serve goes to opposite wings on the two sides. Every rate "
