...
- **Form signal:** regressing a match's realized residual on the form difference entering it gives slope **0.38 ± 0.04** (test era, n=4,628), so recent residuals do carry some information about the next charted match.
